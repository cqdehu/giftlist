...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "SELECT `name`, `status`, `user`, `createDate`, `id`, `userto` FROM `items` WHERE `user` = '$user' AND `userto` = '$userto' AND `id` IN (SELECT `id` FROM `items` WHERE `user` = '$user' AND `userto` = '$userto')";
